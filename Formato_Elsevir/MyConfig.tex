...
\captionsetup[table]{name={Tabla},labelsep=newline,labelfont={bf,color=Micolor}} % Modifica el nombre de las figuras y su separador
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Configuración enpabezado y pie de página
